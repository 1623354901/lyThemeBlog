...
<img src="./media/image-20210209172314832.png" alt="image-20210209172314832" />
...
<img src="./media/image-20210209174438863.png" alt="image-20210209174438863" />
...
<img src="./media/image-20210209212043708.png" alt="image-20210209212043708" style="zoom:70%;" />
...
<img src="./media/image-20210217142711472.png" alt="image-20210217142711472" style="zoom:50%;" />
...
<img src="./media/image-20210217143506046.png" alt="image-20210217143506046" style="zoom:50%;" />
...
<img src="./media/image-20210217145325690.png" alt="image-20210217145325690" style="zoom:30%;" />
...
<img src="./media/image-20210217145504963.png" alt="image-20210217145504963" style="zoom:30%;" />
...
<img src="./media/image-20210214144941345.png" alt="image-20210214144941345" style="zoom:25%;" />
...
<img src="./media/image-20210214150511841.png" alt="image-20210214150511841" style="zoom:25%;" />
...
<img src="./media/image-20210214151037552.png" alt="image-20210214151037552" style="zoom:25%;" />
...
<img src="./images/image-20210305165413588.png" />
...
<img src="./images/image-20210305165848781.png" />
...
<img src="./media/image-20210218233241397.png" alt="image-20210218233241397" style="zoom:50%;" />

下图展示的是重新为形参赋值后的状态：

<img src="./media/image-20210218233343016.png" alt="image-20210218233343016" style="zoom:50%;" />
...
<img src="./images/image-20210305172448582.png" />
...
<img src="./media/image-20210218143938843.png" alt="image-20210218143938843" style="zoom:30%;" />
<img src="./images/image-20210306093300970.png" />
...
<img src="./media/image-20210218171603780.png" alt="image-20210218171603780" style="zoom:45%;" />
...
- 构造函数, 原型对象, 实例的三角关系图
- 原型链如何形成
<img src="./images/image-20210306104516852.png" />
...
<img src="./media/image-20210218212449526.png" alt="image-20210218212449526" style="zoom:50%;" />
...
<img src="./images/image-20210306111112493.png" />
...
<img src="./images/image-20210306114638139.png" />
...
<img src="./images/image-20210306144638905.png" />
...
<img src="./images/image-20201208040306978.png" />

<!-- ![image-20201208040306978](images/image-20201208040306978.png) -->

**事件循环队列 eventLoop**
<img src="./images/image-20201208040235602.png" />
...
<img src="./images/image-20210306151137688.png" />
...
<img src="./images/image-20210306152010989.png" />
...
实际请求报文实例:
<img src="./images/image-20210305232854139.png" />
...
<img src="./media/image-20210219125038371.png" alt="image-20210219125038371" style="zoom:40%;" />
...
小结:
<img src="./images/image-20210306161216371.png" />
...
<img src="./images/image-20210306005550796.png" />
...
<img src="./images/image-20210306011528361.png" />
...
<img src="./images/image-20210308102015595.png" />
...
<img src="./images/image-20210306021532010.png" />
...
<img src="./media/image-20210219160534616.png" alt="image-20210219160534616" style="zoom:30%;" />
...
- 数据流以消息的形式发送，⽽消息⼜由⼀个或多个帧组成（多个帧可以乱序发送，因为可以根据帧⾸部的流标识来重新组装）
  <img src="./images/image-20210306023912779.png" />
...
<img src="./images/940884-20180423141536107-329179455.png" />
...
<img src="./images/image-20210308182724715.png" />
...
1. **max-age** 指定一个时间长度，在这个时间段内缓存是有效的，单位是 s。
   ...
   <img src="./images/image-20210308182737673.png" />
...
<img src="./images/image-20210308182821236.png" />
...
<img src="./images/image-20210308182858733.png" />
...
**浏览器第一次请求**
<img src="./images/image-20210308182913833.png" />

<!-- ![image-20210308182913833](images/image-20210308182913833.png) -->

**浏览器第二次请求**
<img src="./images/image-20210308182925144.png" />
...
<img src="./images/image-20201209160422978.png" />
...
<img src="./images/image-20201209162908979.png" />
...
![image-20210219222213633](./media/image-20210219222213633.png)
...
<img src="./media/image-20210220222103787.png" alt="image-20210220222103787" style="zoom:30%;" />
...
<img src="./media/image-20210220214851409.png" alt="image-20210220214851409" style="zoom:45%;" />
...
<img src="./images/image-20210309091528931.png" />
...
- 浏览器 JS 在处理返回信息(有数据或者超时) 后再次发出请求。服务器收到请求后, 会再次阻塞到有数据或者超时
  ...
  ...
  <img src="./images/image-20210309092038850.png" />
...
<img src="./images/image-20210309092558579.png" />
...
<img src="./media/image-20210221101152845.png" alt="image-20210221101152845" style="zoom:30%;" />
...
![image-20210221103114013](./media/image-20210221103114013.png)
...
2. 生产环境的跨域问题 (使用 nginx 服务器代理)
   ...
   <img src="./images/image-20210308005644520.png" />
...
![image-20210221114506275](./media/image-20210221114506275.png)
...
4. hotfix 分⽀的作⽤是紧急修复⼀些 Bug，它们都是从 master 分⽀上的某个版本建⽴，
   ...
   <img src="./images/image-20210309110119416.png" />

<!-- ![image-20210309110119416](images/image-20210309110119416.png) -->
<img src="./images/image-20210309112949579.png" />
...
<img src="./media/image-20210222132936016.png" alt="image-20210222132936016" style="zoom:30%;" />
...
<img src="./media/image-20210222133524146.png" alt="image-20210222133524146" style="zoom:30%;" />
...
<img src="./media/image-20210223221853817.png" alt="image-20210223221853817" style="zoom:100%;" />
...
<img src="./media/image-20210224084130350.png" alt="image-20210224084130350"  />
...
<img src="./images/image-20210309011422081.png" />
...
<img src="./images/image-20210309122823432.png" />
...
<img src="./images/image-20201208122803496.png" />

<!-- ![image-20201208122803496](images/image-20201208122803496.png) -->
<img src="./images/image-20210309151257119.png" />
...
3. diff 算法: 默认的对比(diff) 机制, 同层兄弟元素, 是按照下标进行对比的, 但是加了 key, **就相当于给虚拟 dom 加了个标识**
   ...
   <img src="./images/image-20210309155633728.png" />
...
4. 使用 Phantomjs `针对爬虫` 做处理
   ...
   <img src="./images/image-20210309024213922.png" />
...
3. 剩下的菜单权限控制，是相对复杂一些的
   ...
   <img src="./images/image-20210309031043592.png" />
...
4. 开启 gzip 压缩 (一般默认服务器开启的, 如果没开, 确实可能会很慢, 可以让后台开一下)
   ...
   ...
   <img src="./images/image-20210309172322244.png" />
...
<img src="./images/image-20210309034800953.png" />
...
<img src="./media/image-20210223093430679.png" alt="image-20210223093430679" style="zoom:30%;" />
...
<img src="./media/image-20210223103127034.png" alt="image-20210223103127034" style="zoom:90%;" />
...
![image-20210223104924017](./media/image-20210223104924017.png)
